...
public class ConsoleGame : Produto{
    ...
    public void Promocao(double desconto){
        Console.WriteLine("Promoção PlayStation 5 com" + desconto + "reais de desconto");
    }
}
...
public class Jogo : Produto{
    ...
    public void Promocao(double desconto){
        Console.WriteLine("Promoção Marvel´s Spider-Man 2 PREMIUM com" + desconto + "reais de desconto");
    }
}
...
public class Acessorio : Produto{
    ...
    public void Promocao(double desconto){
        Console.WriteLine("Luvas de teia com" + desconto + "reais de desconto");
    }
 }
  ...
  public class Colecionavel : Produto{
    ...
    public void Promocao(){
     ...
     public void Promocao(double desconto){
        Console.WriteLine("Bonecos do homem com" + desconto + "reais de desconto");
    }
}
