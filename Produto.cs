...
public class Program {
    ...
    public static void main (String[] args){
        ...
        Arlequina arlequina = new  Arlequina ("Marvel´s Spider-Man 2 PREMIUM", 299,9,"Jogo completo Marvel´s Spider-Man 2 para PS5." , "jogoPS5","Ação e Aventura");

        Pinguim  pinguin =  new Pinguim ("Luvas de teia",300.0,"Cor vermelha e bastante flexivel","Luva","Luva de borracha" );

        Batman batman = new batman("Bonecos do homem ", 150.0,"Um boneco para colecionador","boneco",true);
